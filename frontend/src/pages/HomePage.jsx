...
export default function HomePage() {
  ...
  return (
    <div className="home-page">
      ...
      <p>
        Esta aplicación te permite explorar información detallada sobre los Vocaloids y sus motores asociados. A través de esta herramienta, puedes acceder a datos importantes, gestionar motores Vocaloid y realizar consultas específicas de manera sencilla y eficiente.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Seguridad con JWT:</strong> Todas las operaciones de creación y modificación de datos están protegidas por autenticación mediante tokens JWT.
        </li>
      </ul>

      <h2>Características del Proyecto</h2>
      <p>
        Este proyecto utiliza tecnologías modernas como <strong>Node.js</strong>, <strong>Express</strong>, <strong>MongoDB</strong> y <strong>React</strong>. También implementa prácticas de desarrollo seguro como autenticación con <strong>JWT</strong> para garantizar la integridad de los datos.
      </p>
